...
export function LoanApplication() {
  ...
  const handleSubmit = () => {
    ...
    // Create a log entry in notifications
    const applicationDetails = `Loan Application for ${businessName || 'EcoCorp'} (₹${loanAmount || '25,00,000'}) submitted. Industry: ${industryType}, Revenue: ₹${monthlyRevenue || '5,00,000'}/mo.`;
    ...
    setTimeout(() => {
      ...
      addNotification({
        ...
        desc: "Your loan application has been recorded on the blockchain audit trail.",
        icon: CheckCircle2,
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      placeholder="EcoCorp Manufacturing" 
                    />
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <select 
                      ...
                      className="w-full rounded-xl bg-navy-deep p-3 text-slate-soft outline-none ring-1 ring-white/10 focus:ring-indigo-primary/50"
                    >
              ...
              <div className="space-y-6">
                ...
                <div className="rounded-2xl bg-white/5 p-6 space-y-4">
                  <div className="flex justify-between border-b border-white/5 pb-2">
                    ...
                    <span className="font-medium text-slate-soft">{businessName || 'EcoCorp Manufacturing'}</span>
                  </div>
                  <div className="flex justify-between border-b border-white/5 pb-2">
                    <span className="text-slate-muted">Loan Amount</span>
                    <span className="font-medium text-slate-soft">₹ {loanAmount || '25,00,000'}</span>
                  </div>
                  <div className="flex justify-between border-b border-white/5 pb-2">
