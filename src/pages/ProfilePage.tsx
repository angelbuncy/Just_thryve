  ...
  const handleSaveProfile = async () => {
    ...
    try {
      ...
      addNotification({
        ...
        desc: "Your profile information has been successfully saved.",
        type: 'success'
      });
      setIsEditing(false);
    } catch (error) {
      addNotification({
        title: "Update Failed",
        desc: error instanceof Error ? error.message : "Could not save profile changes.",
        type: 'error'
      });
    } finally {
      setIsSaving(false);
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <input 
                          ...
                          disabled={!isEditing}
                          className="w-full bg-white/5 border border-white/10 rounded-xl py-2.5 pl-10 pr-4 text-slate-soft outline-none focus:ring-1 focus:ring-indigo-primary/50 disabled:opacity-50"
                        />
                      </div>
                    </div>
                    <div className="space-y-2">
